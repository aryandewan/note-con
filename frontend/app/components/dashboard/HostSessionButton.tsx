...
export function HostSessionButton() {
  ...
  return (
    <button
      type="button"
      onClick={() => openHost()}
      className="inline-flex cursor-pointer items-center gap-2 rounded-full bg-primary px-5 py-2.5 font-display text-[0.98rem] font-bold text-cloud shadow-card transition-colors hover:bg-primary-hover hover:shadow-pop"
    >
